...
// changes the stroke colour of the drawing canvaskonduri
...
function clearDrawing() {
    ...
    drawingCanvasCxt.clearRect(0,0,700,450);
}
...
function initializeCanvas() {
    ...
    var pencilBrush = new PencilBrush(5, drawingCanvasCxt),
        ...
        rectangleBrush = new RectangleBrush(5, drawingCanvasCxt,overlayCanvasCxt),
        circleBrush = new CircleBrush(5, drawingCanvasCxt,overlayCanvasCxt),
        lineBrush = new LineBrush(5, drawingCanvasCxt,overlayCanvasCxt),
